...
_EXPECTED_OPERATION_METADATA: dict[str, tuple[object, bool, str, object, bool]] = {
    ...
    "allowConsoleSession": ("console session allow", True, "forbidden", None, False),
    ...
    **RULING_OPERATION_METADATA,
    ...
    "revokeConsoleSession": ("console session revoke", True, "forbidden", None, False),
    ...
    "setConsoleKillSwitch": ("console kill-switch set", True, "forbidden", None, False),
