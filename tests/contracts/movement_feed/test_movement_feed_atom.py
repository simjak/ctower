...
_ATOM_VECTOR = b"""<?xml version="1.0" encoding="utf-8"?>
<feed xmlns="http://www.w3.org/2005/Atom">
  ...
  <entry>
    ...
    <updated>2026-08-09T12:00:00Z</updated>
    <link rel="alternate" href="/v1/tickets/00000000-0000-7000-8000-000000000002/timeline" />
  </entry>
</feed>
"""
...
def test_atom_contract_vector_is_validator_clean_with_stable_entry_identity() -> None:
    ...
    assert any(
        link.rel == "alternate"
        and link.href == "/v1/tickets/00000000-0000-7000-8000-000000000002/timeline"
