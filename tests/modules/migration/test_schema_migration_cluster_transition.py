...
FINAL_SCHEMA_SHA256 = "sha256:da7b6db4d7eb3f0acafe9395d8b76c90886dfcbb5bd4455f07f19c2a7278ee45"
...
def test_declared_cluster_transition_advances_the_recorded_0063_instance(
    ...
    assert [row[0] for row in recorded_after[-2:]] == [
