...
# Every project minted here must survive a dying test runner without becoming a
# zombie. Normal cleanup and the atexit/SIGTERM/SIGINT paths share this registry;
# teardown is idempotent and best-effort under any interpreter state.
