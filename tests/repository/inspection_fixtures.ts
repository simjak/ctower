...
const ACCEPTED: readonly Inspection[] = [
  ...
  { op: "git.show", root: ROOT, revision: "HEAD", path: "docs/internal/CODING_STANDARDS.md" },
  { op: "git.pathLog", root: ROOT, path: "docs/internal/CODING_STANDARDS.md" },
  ...
  { op: "git.diffPath", root: ROOT, base: "origin/main", path: "docs/internal/SPEC.md" },
  { op: "crontab.list" },
  { op: "systemd.timers" },
  { op: "tmux.sessions" },
  { op: "tmux.crews" },
