...
class EventKind(StrEnum):
    ...
    ROUTINE_WORK_ITEM_APPENDED = "routine.work_item_appended"
    ROUTINE_WORK_ITEM_SUPPRESSED = "routine.work_item_suppressed"
    ROUTINE_WORK_ITEM_COMPLETED = "routine.work_item_completed"
    ROUTINE_WORK_ITEM_ALARM_RAISED = "routine.work_item_alarm_raised"
