...
REVOKE ALL ON workflow_review_dispatch_effects, workflow_review_dispatch_lenses,
    workflow_review_dispatch_consumptions, workflow_review_dispatch_verdict_links
    FROM PUBLIC, ctower_svc, ctower_projection;
GRANT INSERT, SELECT ON workflow_review_dispatch_effects, workflow_review_dispatch_lenses,
    workflow_review_dispatch_consumptions, workflow_review_dispatch_verdict_links
    TO ctower_svc;
GRANT SELECT ON workflow_review_dispatch_effects, workflow_review_dispatch_lenses,
    workflow_review_dispatch_consumptions, workflow_review_dispatch_verdict_links
