...
This page defines the evidence boundary for CT-I1-019. It covers only the read-only viewer server foundation.
...
CT-I1-019 satisfies only the Q3 prerequisite that a proven Phase-1 viewer foundation exist; it activates no
