...
| ctower-ui Inbox promotion | Development dogfood | The separate server-mediated Inbox control may invoke the existing promotion endpoint for low-value shadow dogfood. It holds no browser credential or authority and is not a product browser route. |
...
control is the narrow D40 exception.
