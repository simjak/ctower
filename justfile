...
python-check: compatibility-coverage
    {{python}} -m ruff format --check apps/ctower-api/src apps/ctower-runner/src apps/ctowerctl/src packages/ctower-kernel/src packages/ctower-runner-sdk/src tools/checks tools/codegen tools/compatibility tools/development_runtime tools/landing_boundary tools/migration tools/process_execution.py tools/runtime_manifest tools/runtime_preflight.py tools conftest.py tests/test_manifest_generation.py tests/repository tests/contracts tests/compatibility tests/type_overlays tests/integration tests/landing_boundary tests/modules tests/artifact tests/development_runtime tests/acceptance/increment-1 tests/conformance
    {{python}} -m ruff check --no-cache apps/ctower-api/src apps/ctower-runner/src apps/ctowerctl/src packages/ctower-kernel/src packages/ctower-runner-sdk/src tools/checks tools/codegen tools/compatibility tools/development_runtime tools/landing_boundary tools/migration tools/process_execution.py tools/runtime_manifest tools/runtime_preflight.py tools conftest.py tests/test_manifest_generation.py tests/repository tests/contracts tests/compatibility tests/type_overlays tests/integration tests/landing_boundary tests/modules tests/artifact tests/development_runtime tests/acceptance/increment-1 tests/conformance
    {{python}} -m mypy --no-incremental --exclude tests/acceptance/increment-1/conftest.py apps/ctower-api/src apps/ctower-runner/src apps/ctowerctl/src packages/ctower-kernel/src packages/ctower-runner-sdk/src tools/checks tools/codegen tools/compatibility tools/development_runtime tools/landing_boundary tools/migration tools/process_execution.py tools/runtime_manifest tools/runtime_preflight.py generated/python conftest.py tests/test_manifest_generation.py tests/repository tests/contracts tests/compatibility tests/integration tests/landing_boundary tests/modules tests/artifact tests/development_runtime tests/acceptance/increment-1 tests/conformance
