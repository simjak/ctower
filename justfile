...
python-check: compatibility-coverage
    {{python}} -m ruff format --check apps/ctower-api/src apps/ctowerctl/src packages/ctower-kernel/src tools/checks tools/codegen tools/compatibility tools/development_runtime tools/release_manifest tests/repository tests/contracts tests/compatibility tests/integration tests/modules tests/artifact tests/acceptance/increment-1
    ...
    {{python}} -m mypy --no-incremental apps/ctower-api/src apps/ctowerctl/src packages/ctower-kernel/src tools/checks tools/codegen tools/compatibility tools/development_runtime tools/release_manifest generated/python tests/repository tests/contracts tests/compatibility tests/integration tests/modules tests/artifact tests/acceptance/increment-1
