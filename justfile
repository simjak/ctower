...
python-check: compatibility-coverage
    {{python}} -m ruff format --check apps/ctower-api/src packages/ctower-kernel/src tools/checks tools/codegen tools/compatibility tests/repository tests/contracts tests/compatibility tests/acceptance/increment-1
    {{python}} -m ruff check --no-cache apps/ctower-api/src packages/ctower-kernel/src tools/checks tools/codegen tools/compatibility tests/repository tests/contracts tests/compatibility tests/acceptance/increment-1
    {{python}} -m mypy --no-incremental apps/ctower-api/src packages/ctower-kernel/src tools/checks tools/codegen tools/compatibility generated/python tests/repository tests/contracts tests/compatibility tests/acceptance/increment-1
