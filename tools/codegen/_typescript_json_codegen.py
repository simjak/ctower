"""Render the dependency-free TypeScript raw-token JSON response parser."""

from __future__ import annotations

__all__ = ["render_typescript_json_parser"]


def render_typescript_json_parser(digest: str) -> str:
    """Render one JSON grammar parser that preserves every numeric lexeme."""
