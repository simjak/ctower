...
| <a id="ac-req-02"></a>AC-REQ-02 | Request triage, priority, owner, blocker, required/optional Ticket relation, duplicate/rejection, and closure-evaluation commands enforce the exact authority matrix and expected versions. Zero/one/many Ticket, self/cycle/race, proof invalidation, blocker, relation-change, and canonical-Request-change fixtures derive the specified state and never mutate Ticket authority implicitly. | `tests/acceptance/increment-1/test_requests.py::test_request_ticket_relations_and_closure_are_independent`, authority/refusal matrix, and rebuild equality |
