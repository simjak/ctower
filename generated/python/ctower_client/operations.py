...
OPERATIONS = MappingProxyType(
    {
        ...
        "appendSpawnTransition": OperationSpec(
            operation_id="appendSpawnTransition",
            client_method="append_spawn_transition",
            method="POST",
            path="/v1/spawn-records/{spawn_id}/transitions",
            request_model=_models.SpawnTransitionRequest,
            response_model=_models.SpawnRecordResult,
            cli_names=('spawn transition',),
            mutation=True,
            spool_policy=SpoolPolicy.ALLOWED,
            principal=None,
            refusal_only=False,
        ...
        "createSpawnRecord": OperationSpec(
            operation_id="createSpawnRecord",
            client_method="create_spawn_record",
            method="POST",
            path="/v1/spawn-records",
            request_model=_models.SpawnRecordCreateRequest,
            response_model=_models.SpawnRecordResult,
            cli_names=('spawn record',),
            mutation=True,
            spool_policy=SpoolPolicy.ALLOWED,
            principal=None,
            refusal_only=False,
        ...
        "getSpawnRecord": OperationSpec(
            operation_id="getSpawnRecord",
            client_method="get_spawn_record",
            method="GET",
            path="/v1/spawn-records/{spawn_id}",
            request_model=None,
            response_model=_models.SpawnRecord,
            cli_names=('spawn show',),
            mutation=False,
            spool_policy=SpoolPolicy.FORBIDDEN,
            principal='authenticated',
            refusal_only=False,
        ...
        "listSpawnRecords": OperationSpec(
            operation_id="listSpawnRecords",
            client_method="list_spawn_records",
            method="GET",
            path="/v1/spawn-records",
            request_model=None,
            response_model=_models.SpawnRecordListResult,
            cli_names=('spawn list',),
            mutation=False,
            spool_policy=SpoolPolicy.FORBIDDEN,
            principal='authenticated',
            refusal_only=False,
...
CLI_OPERATIONS = MappingProxyType(
    {
        ...
        "spawn transition": OPERATIONS["appendSpawnTransition"],
        ...
        "spawn record": OPERATIONS["createSpawnRecord"],
        ...
        "spawn show": OPERATIONS["getSpawnRecord"],
        ...
        "spawn list": OPERATIONS["listSpawnRecords"],
