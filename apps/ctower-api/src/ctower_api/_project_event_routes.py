"""Authenticated HTTP adapter for the project-scoped typed event feed."""
...
def install_project_event_routes(
    ...
    """Install the read-only project-scoped typed event feed."""
    ...
    def list_project_events(
        ...
        outcome = record.event_audit.project_events(
...
def _read_response(outcome: ProjectEventPage) -> JSONResponse:
    boundary = HttpProjectEventPage.model_validate_json(_encoded(outcome.response_payload()))
