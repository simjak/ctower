...
- The browser product surfaces and the former `ctower-ui` runtime are removed under D75 until the separately activated product browser checkpoint; generated TypeScript remains an API client for contract coverage, not a product UI.
