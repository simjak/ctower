...
class LockedStore:
    ...
    def _stored_file(self, directory: DirectoryName, name: str) -> StoredFile:
        ...
        file_descriptor = os.open(name, _FILE_READ_FLAGS, dir_fd=self._directories[directory])
        try:
        ...
        return StoredFile(directory, name, sequence, kind, details.st_size, identity)
