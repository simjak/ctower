...
export const NO_CHANGE_SIZE = capability(
  "the size of a ticket's changes — the record carries the references, not the lines",
  null
);
...
export const NO_TICKET_INVENTORY = capability(
  "a ticket that is not on this projection — every ticket read takes an identifier the caller already holds",
  null
);
