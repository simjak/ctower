  ...
  resources: [
    {
      ...
      payload: { schema: "ctower.capability/v1", key: CAPABILITY.key, display_name: "Read tickets" },
    },
    {
      ...
      payload: {
        ...
        key: "acme.ada",
        display_name: "Ada",
        instructions_digest: "sha256:0f1e2d3c4b5a69788796a5b4c3d2e1f00f1e2d3c4b5a69788796a5b4c3d2e1f0",
      },
    },
    {
      ...
      payload: {
        ...
        instructions_digest: "sha256:1f2e3d4c5b6a79808897a6b5c4d3e2f11f2e3d4c5b6a79808897a6b5c4d3e2f1",
