 ...
 */
export function RepositoryLink({ repository }: { readonly repository: Repository }): ReactElement {
  ...
  if (repository.href === null || repository.site === null) {
    return <Mono className="mt-0.5 block truncate text-muted">{repository.label}</Mono>;
  }
  ...
  return (
    <a
      ...
      className="mt-0.5 inline-flex max-w-full items-center gap-1.5 text-muted hover:text-amber-ink hover:underline"
    >
